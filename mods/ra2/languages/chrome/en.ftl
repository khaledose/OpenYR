...
label-mainmenu-prerelease-notification-prompt-title = Yuri's Revenge Disclaimer
...
label-mainmenu-prerelease-notification-prompt-text-c = Yuri's Revenge is in an early Beta stage as well. Neither design,
